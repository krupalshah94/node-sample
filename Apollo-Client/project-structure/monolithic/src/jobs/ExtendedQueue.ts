...
/**
 * Represents an extended queue that extends the functionality of the Queue class.
 * 
 ...
 * @returns A promise that resolves when the job status is updated in the database.
 */
 ...
 * 
 * @param jobId - The ID of the job to update.
 * @param nextJobId - The ID of the next job.
 * @returns A promise that resolves when the job status is updated in the database.
 */
