...
type TQuery = { getWorkLogs: WorkLog };
...
const GET_WORK_LOGS_QUERY = `query ($taskId: ID!) {
  getWorkLogs(taskId: $taskId) {
      id
      time
      date
...
describe('gql/resolvers/Query/workLog/getWorkLogs', () => {
  ...
  // success
  it('should allow to get work logs', async () => {
