...
type TQuery = { unarchiveContract: Contract };
...
const UNARCHIVE_CONTRACT_MUTATION = `mutation($contractId: ID!) {
  unarchiveContract(contractId: $contractId) {
    id
    introMessage
    name
    relativeDates
...
describe('gql/resolvers/Mutation/contracts/unarchive', () => {
  ...
  // success
  it('should allow to unarchive already unarchive contract', async () => {
    ...
    const result = data?.unarchiveContract;
  ...
  it('should allow to unarchive contract', async () => {
