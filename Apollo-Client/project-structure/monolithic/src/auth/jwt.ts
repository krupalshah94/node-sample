...
/**
 * Generates an HMAC signature for the provided secured input using the SHA256 algorithm and the given secret key.
 * 
 * @param securedInput - The secured input to be signed.
 * @param secretKey - The secret key used for signing.
 * @returns The HMAC signature as a URL-safe base64-encoded string.
 */
...
/**
 * Signs the input using RSA-SHA256 algorithm and returns the signature.
 * 
...
/**
 * Signs the input using ECDSA algorithm with the provided private key.
 * 
 * @param securedInput - The input to be signed.
 * @param privateKey - The private key used for signing.
 ...
 * @throws {Error} - If the JWT is invalid or does not have three segments.
 */
