 ...
 * @param args - The arguments for generating the authentication token.
 * @param args.user - The user object.
 * @param args.jwtSecret - The secret key for signing the token.
 ...
 * @returns {AuthTokenPayload | DeprecatedAuthTokenPayload} - The payload of the JWT token.
 */
 ...
 * @param {TArgs} args - The arguments for the operation.
 * @returns {Promise<TReturn>} - A promise that resolves to the result of the operation.
 */
 ...
 */
  ...
  /**
 * Executes the updatePassword function.
 * 
 * @param client - The GraphQL client.
 * @param args - The arguments for the updatePassword function.
 * @param ctx - The context object.
 ...
 * @throws {LoginError} If the user's account has been deleted, locked, or if the password is invalid.
 */
 ...
 * @param ctx - The context object.
 * @returns A promise that resolves to an object containing the registered user, their role, and an authentication token.
