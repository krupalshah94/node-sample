 ...
 * @returns A Promise that resolves to the role name if the user is an admin, or void if the user is impersonating or not authorized.
 * @throws GraphQLError - If the user is not authorized or does not have the admin role.
 */
